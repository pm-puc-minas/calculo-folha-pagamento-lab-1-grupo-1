...
/*
 * Entidade de persistência que representa um Funcionário.
 * Mapeia a tabela 'employees' no banco de dados, centralizando informações pessoais,
 * contratuais e configurações de benefícios essenciais para o cálculo da folha.
 */
...
public class Employee {
    ...
    // --- Dados Cadastrais e Documentação ---
    @NotBlank
    @Column(name = "full_name")
    private String fullName;

    @NotBlank
    @Column(unique = true) // Garante unicidade do documento no banco
    private String cpf;
    ...
    // --- Planos Complementares (Saúde e Bem-estar) ---
    ...
    // Construtor padrão com inicialização de auditoria
    public Employee() {
